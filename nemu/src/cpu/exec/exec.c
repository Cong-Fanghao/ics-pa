...
opcode_entry opcode_table [512] = {
  ...
  /* 0x68 */	EMPTY, IDEX(SI_E2G, imul3), IDEX(I_E2G, imul3), EMPTY,
  ...
  /* 0xc8 */	EX(leave), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xb4 */	IDEXW(mov_E2G, movzx, 1), IDEX(mov_E2G, movzx), IDEXW(mov_E2G, movsx, 1), IDEX(mov_E2G, movsx),
